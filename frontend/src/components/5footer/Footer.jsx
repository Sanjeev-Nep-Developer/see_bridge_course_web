    ...
    <footer className="text-gray-600 body-font">
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
          <img src={img} fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" className="w-10 h-10 text-white p-0 bg-indigo-900 rounded-full" viewBox="0 0 24 24"/>
            
          <span className="ml-3 text-xl">Padhega Nepal</span>
        </a>
        <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2023 padhegaNepal —
          <span className="text-gray-600 ml-1">@sanjeev</span>
        </p>
